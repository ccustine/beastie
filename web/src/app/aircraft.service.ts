...
export class AircraftService {
  ...
  getAircraftStream(): Observable<AircraftResponse> {
    return Observable.create((observer) => {
      const eventSource = new EventSourcePolyfill(environment.streamUrl, { heartbeatTimeout: 10000, connectionTimeout: 10000 });
  ...
  getAircraft(): Observable<AircraftResponse> {
    ...
    return this.http.get<AircraftResponse>(environment.aircraftUrl)
  }
